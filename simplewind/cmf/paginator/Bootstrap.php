...
class Bootstrap extends Paginator
{
    ...
    {
        return '<li class="item"><a class="" href="' . htmlentities($url) . '">' . $page . '</a></li>';
    }
    ...
    {
        return '<li class="item disabled"><span class="">' . $text . '</span></li>';
    }
    ...
    {
        return '<li class="active item disabled" ><span class="">' . $text . '</span></li>';
    }
