...
class UserModel extends Model
{
    ...
    {
        return $this->belongsToMany('FieldModel','field_user','field_id','user_id');
    }

    public function institution2(){
        return $this->belongsTo('InstitutionModel','id','user_id')->bind([
            'real_name',
            'institution_name',
            'city_id',
            'fields'=>'field'
    ...
    {
        return $this->belongsTo('InstitutionModel', 'id', 'user_id');
    }
    ...
    public function registerInsitituion($user, $type)
    {
        switch ($type) {
            case 1:
                $result = Db::name("user")->where('user_login', $user['user_login'])->find();
    ...
    public function editData($user)
    {
        ...
        $field = 'user_nickname,sex,birthday,user_url,signature,more,user_city_id';
        $result = $this->allowField($field)->save($user, ['id' => $userId]);
        if ($result) {
