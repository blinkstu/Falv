...
class Bootstrap extends Paginator
{
    ...
    {
        return '<li class="item"><a class="page-link" href="' . htmlentities($url) . '">' . $page . '</a></li>';
    }
    ...
    {
        return '<li class="item disabled"><span class="page-link">' . $text . '</span></li>';
    }
    ...
    {
        return '<li class="active item disabled" ><span class="page-link">' . $text . '</span></li>';
    }
