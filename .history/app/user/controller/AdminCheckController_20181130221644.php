...
class AdminCheckController extends AdminBaseController
{
    ...
    public function userFetch(){
        ...
        $count = $UserModel::hasWhere('role', ['role_id' => '2'])->order("create_time DESC")->where('user_status=3')->whereOr('user_status=4')->select();
        $users = $UserModel::hasWhere('role', ['role_id' => '2'])->with('institution2,field')->order("create_time DESC")->where('user_status=3')->whereOr('user_status=4')->select();
