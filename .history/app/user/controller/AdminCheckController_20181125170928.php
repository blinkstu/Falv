...
class AdminCheckController extends AdminBaseController
{
    ...
    public function userFetch(){
        ...
        $users = $UserModel::hasWhere('role', ['role_id' => '2'])->with('institution')->order("create_time DESC")->where('user_status=3')->bind('real_name,institution_name,city_id,phone_number')->select();
