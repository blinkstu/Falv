$("#private").on("click", function() {
  $(".register-choose").hide();
  $(".private-reg").show();
  $(".private-reg").animateCss("zoomIn");
});
$("#institution").on("click", function() {
  $(".register-choose").hide();
  $(".institution-reg").show();
  $(".institution-reg").animateCss("zoomIn");
});
$(".back-reg").click(function(e) {
  e.preventDefault();
  $(".private-reg").hide();
  $(".institution-reg").hide();
  $(".register-choose").show();
  $(".register-choose").animateCss("zoomIn");
});
$.fn.selectify = function() {
  ...
  option.each(function() {
    ...
    $(".select-wrap ul").append("<li data-id='" + id + "' >" + label + "</li>");
  });
  ...
  $(document).on("click", ".select-wrap ul li", function() {
    ...
    function inFilter() {
      ...
      var filter = $(
        "<div class='filter'>" +
          dis.text() +
          "<input name='field[data][]' value='" +
          dis.data("id") +
          "' type='hidden'></input></div>"
      );
